	...
	if($(".woosung_wrap .tab_area ul li.active").hasClass("child01")){ //사인탑
        if($("#sigh_option01").is(":checked")){ //비조명
            	...
            	(function(){
                    ...
                    (function(){ var backdropColorP=getBackdropColorPrice(),_bD=getSignDimensions(); if(colorP>0||backdropColorP>0){ if($("#sigh_frame_color_custom").is(":checked")){ var txt=""; if(colorP>0) txt+=_fmt(Math.round(tw*1000))+"×"+_fmt(Math.round(tv*1000))+"mm("+Math.round(tw*tv)+"m²) × "+_fmt(PRICES.sign_color_paint_nol)+"원 = "+_fmt(colorP)+"원"; if(backdropColorP>0) txt+=(colorP>0?" / ":"")+"("+_fmt(Math.round(_bD.w*1000))+"+"+_fmt(Math.round(_bD.h*1000))+"+"+_fmt(Math.round(_bD.w*1000))+"+"+_fmt(Math.round(_bD.h*1000))+")mm × 6,000원/m = "+_fmt(backdropColorP)+"원"; bd+="<span class='bd_item'>색상도장 <em>"+txt+"</em></span>"; } else if(colorP>0) bd+="<span class='bd_item'>스텐몰딩 <em>둘레 "+_fmt(Math.round((tw*2+tv*2)*1000))+"mm × "+_fmt(PRICES.sign_sten_molding)+"원/m = "+_fmt(colorP)+"원</em></span>"; } })();
            	...
            	(function(){
                    ...
                    (function(){ var backdropColorP=getBackdropColorPrice(),_bD=getSignDimensions(); if(colorP>0||backdropColorP>0){ if($("#sigh_frame_color_custom").is(":checked")){ var txt=""; if(colorP>0) txt+=_fmt(colorP)+"원"; if(backdropColorP>0) txt+=(colorP>0?" / ":"")+"("+_fmt(Math.round(_bD.w*1000))+"+"+_fmt(Math.round(_bD.h*1000))+"+"+_fmt(Math.round(_bD.w*1000))+"+"+_fmt(Math.round(_bD.h*1000))+")mm × 6,000원/m = "+_fmt(backdropColorP)+"원"; bd+="<span class='bd_item'>색상도장 <em>"+txt+"</em></span>"; } else if(colorP>0) bd+="<span class='bd_item'>색상도장 <em>"+_fmt(colorP)+"원</em></span>"; } })();
